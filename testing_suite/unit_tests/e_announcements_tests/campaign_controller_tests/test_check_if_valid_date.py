...
class CheckIfValidDateTestCase(CampaignControllerBaseTestCase):
    ...
    def test_check_if_valid_date(self):
        ...
        valid_date = datetime(day=15, month=12, year=2017)
        ...
        too_early_date = datetime(day=1, month=1, year=2017)
        ...
        tuesday_date = datetime(day=26, month=12, year=2017)
        ...
        holiday_date = datetime(day=25, month=12, year=2017)
