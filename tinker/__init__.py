...
if "testing" not in platform.node():
    ...
    #             'WUFOO_BASE_URL','BASE_ASSET_EVENT_FOLDER','SENTRY_URL',
    #             'SITE_ID','CLIENT_ID','CASCADE_LOGIN','SECRET_KEY',
    #             'THUMBOR_CALL_CMD','DATA_DEF_PROGRAM_FEED_ID','CACHE_DEFAULT_TIMEOUT','GITHUB_CREDENTIALS',
    #             'DATA_DEF_PROGRAM_BLOCK_ID','API_URL','E_ANN_ADMINS',
    ...
    #             'FACULTY_BIOS_XML_URL','METADATA_ROBUST_ID','E_ANN_BASE_ASSET','EVENTS_FOLDER_ID',
