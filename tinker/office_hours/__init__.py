...
class OfficeHoursView(FlaskView):
    ...
    def index(self):
        ...
        return render_template('office-hours/office-hours-home.html', **locals())
    ...
    def edit(self, block_id):
        ...
        return render_template('office-hours/office-hours-form.html', **locals())
    ...
    def submit(self):
        ...
        return render_template('office-hours/office-hours-confirm.html', **locals())
