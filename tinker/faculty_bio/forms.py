...
class FacultyBioForm(Form):
    ...
    areas = TextAreaField('Areas of expertise', description="A max of 2000 characters is permitted. Current count: ", validators=[validators.length(max=350,message="Character limit exceeded. A max of 2000 characters is allowed.")])
    research_interests = TextAreaField('Research interests', description="A max of 2000 characters is permitted. Current count: ", validators=[validators.length(max=350,message="Character limit exceeded. A max of 2000 characters is allowed.")])
    teaching_specialty = TextAreaField('Teaching specialty', description="A max of 2000 characters is permitted. Current count: ", validators=[validators.length(max=350,message="Character limit exceeded. A max of 2000 characters is allowed.")])
